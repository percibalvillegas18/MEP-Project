...
<title>Create Admin — MEP Projects Portal</title>
...
<div class="auth-card">
    ...
    <p class="subtitle">Run this once after importing database.sql. This page is disabled after the first admin is created.</p>
    ...
    <form method="post">
        ...
        <div class="auth-input-wrap">
            ...
            <input type="password" name="password" id="adminPass" placeholder="Password" minlength="12" required>
            <button type="button" class="pass-toggle" onclick="togglePass('adminPass',this)" aria-label="Show password">
        ...
        <button class="btn-signin">Create Admin <span class="btn-arrow">&rarr;</span></button>
    </form>
    <div class="auth-divider"><span>or</span></div>
    <p class="footer-text"><a href="login.php">&larr; Back to login</a></p>
</div>
